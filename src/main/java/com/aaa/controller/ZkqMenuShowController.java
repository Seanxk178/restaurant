...
import com.aaa.config.HttpClientHelper;
...
public class ZkqMenuShowController {
 ...
 //   @Scheduled(fixedRate = 1000)
    ...
    @RequestMapping("/code")
    @ResponseBody
    public Object code(String co){
        HttpClientHelper http = new HttpClientHelper();
        Object a = null;
        try {
            a = http.sendGet("https://api.weixin.qq.com/sns/jscode2session?appid=wx17f8676dbb073d7e&secret=ec95240d8905786f5a5ef91d800edff4&js_code="+co);
